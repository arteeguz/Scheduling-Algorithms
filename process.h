...
public:
    ...
    int getTotalSwitchTime(){
        return totalSwitchTime;
    }

    void setTotalSwitchTime(int totalSwitchTime){
        this->totalSwitchTime = totalSwitchTime;
    }
...
private:
    ...
    int burstTime; //Time required to execute process
    int remainingBurstTime; //Don't change burstTime once its set, we need to reuse it for RR func
